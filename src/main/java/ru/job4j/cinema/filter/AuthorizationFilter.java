...
public class AuthorizationFilter extends HttpFilter {
    ...
    private boolean isAlwaysPermitted(String uri) {
        return uri.startsWith("/user/register") || uri.startsWith("/user/login")
                || uri.startsWith("/films/schedule") || uri.startsWith("/films/library")
                || uri.startsWith("/index") || uri.startsWith("/error")
